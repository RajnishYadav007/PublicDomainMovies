...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: 'Twitter',
      url: import.meta.env.VITE_TWITTER_URL || 'https://twitter.com/archivemovies',
      icon: (
    ...
    {
      name: 'Facebook',
      url: import.meta.env.VITE_FACEBOOK_URL || 'https://facebook.com/archivemovies',
      icon: (
    ...
    {
      name: 'YouTube',
      url: import.meta.env.VITE_YOUTUBE_URL || 'https://youtube.com/@archivemovies',
      icon: (
    ...
    {
      name: 'GitHub',
      url: import.meta.env.VITE_GITHUB_URL || 'https://github.com/archivemovies',
      icon: (
