 ...
 * ✅ Updated siteName from .env
 * ✅ Extended decade range to 1890s-1970s
 * 
 * Includes:
 * - Quick links navigation
 * - Legal pages (Privacy, DMCA, Terms, FAQ)
...
export default function Footer() {
  ...
  const siteName = import.meta.env.VITE_SITE_NAME || 'Public Domain Movies';
  ...
  const footerLinks = {
    ...
    decades: [
      ...
      { to: '/category/decade/1970s', label: '1970s Films' }
    ],
    legal: [
  ...
  const socialLinks = [
    {
      ...
      label: 'Follow Public Domain Movies on Twitter',
      icon: (
    ...
    },
    {
      ...
      label: 'Follow Public Domain Movies on Facebook',
      icon: (
    ...
    },
    {
      ...
      label: 'Subscribe to Public Domain Movies on YouTube',
      icon: (
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-4">
              Watch free public domain classic movies online from Internet Archive. 
              Stream vintage films from 1890s-1970s legally without registration.
            </p>
            
            <Link 
              to="/about"
              className="inline-flex items-center gap-1 text-blue-600 dark:text-blue-400 hover:underline text-sm font-medium
                       focus:outline-none focus:ring-2 focus:ring-blue-400 rounded transition-colors"
              aria-label="Learn more about Public Domain Movies"
            >
              Learn more about us
                ...
                <li key={link.to}>
                  <Link
                    ...
                    className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 
                             text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 rounded inline-block"
                    aria-label={`Browse ${link.label}`}
                  >
                    {link.label}
                  </Link>
                </li>
              ...
              {footerLinks.decades.map(link => (
                <li key={link.to}>
                  <Link
                    ...
                    className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 
                             text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 rounded inline-block"
                    aria-label={`Browse movies from ${link.label}`}
                  >
                    {link.label}
                  </Link>
                </li>
                ...
                <li key={link.to || link.href}>
                  {link.external ? (
                    <a
                      ...
                      aria-label={`Visit ${link.label} website (opens in new tab)`}
                    >
                      {link.label}
            ...
            <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-800">
              <a
                ...
                className="text-blue-600 dark:text-blue-400 hover:underline text-sm inline-flex items-center gap-1
                         focus:outline-none focus:ring-2 focus:ring-blue-400 rounded transition-colors"
                aria-label="Send email to Public Domain Movies support"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 pt-8">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-gray-500 dark:text-gray-500 text-xs mt-1">
                ...
                <a
                  ...
                  aria-label="Visit Internet Archive official website (opens in new tab)"
                >
                  Internet Archive
                </a>
                {' '}• Public Domain Films
            ...
            <div className="flex items-center gap-4">
              ...
              {socialLinks.map(social => (
                <a
                  ...
                  rel="noopener noreferrer"
                  className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 
                           transition-all focus:outline-none focus:ring-2 focus:ring-blue-400 rounded-full p-2 hover:scale-110"
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-800">
            <p className="text-gray-500 dark:text-gray-500 text-xs text-center leading-relaxed max-w-4xl mx-auto">
              <strong>Legal Disclaimer:</strong> All movies on this site are verified public domain 
              or openly licensed content. We do not host any video files — all content is embedded 
              from Internet Archive. Users are responsible for independently verifying copyright 
              status before redistribution or commercial use. See our{' '}
              <Link to="/dmca" className="text-blue-600 dark:text-blue-400 hover:underline">
                DMCA Policy
              </Link>{' '}
          ...
          <div className="flex justify-center mt-6">
            <button
              ...
              className="inline-flex items-center gap-2 text-gray-600 dark:text-gray-400 
                       ...
                       rounded px-4 py-2 hover:scale-105"
